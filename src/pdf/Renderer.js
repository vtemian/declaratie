      ...
      <Page style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.text}>
            ...
            <Text style={styles.textBold}> {form?.adresa_bloc}</Text>, etaj
            <Text style={styles.textBold}> {form?.adresa_etaj}</Text>, apartament
            <Text style={styles.textBold}> {form?.adresa_apartament}</Text>, având CNP
